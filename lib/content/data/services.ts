...
export const services: Service[] = [
  ...
  // Reframed per PRD — no IICRC certification claims, no 24/7 emergency framing.
  {
    slug: "water-damaged-carpet-drying",
    name: "Water-damaged Carpet & Upholstery Drying",
    shortDescription:
      "Honest cleanup of water-affected carpets and upholstery after a leak or flood event.",
    longDescription:
      "If a burst pipe or storm has soaked your carpet or upholstery, we extract the water, set up air movers and dehumidifiers, and clean and treat the affected area. This is cleanup work, not emergency response — for active flooding, call a 24/7 emergency restoration provider first; we can come in once the source is stopped.",
    whatsIncluded: [
